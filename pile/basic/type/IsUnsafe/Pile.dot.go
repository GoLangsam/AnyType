...
// NewS returns a (pointer to a) fresh Pile
// of items (of type `uintptr`)
// with size as initial capacity
// and
// with buff non-blocking Add's before respective Next's
func New(size, buff int) *Pile {
	pile := new(Pile)
...
//
// Note: Upon close of the done-channel, the Pile is Reset() so You may start traversing it (via Next) right away.
